...
export default function Tester() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      // Execute logic based on the specific hash value
      if (hash === '#instructions') {
        // Logic for instructions section
        instructionsRef.current.scrollIntoView({ behavior: 'smooth' });
      } else if (hash === '#tech-specs') {
        // Logic for tech specs section
        techSpecsRef.current.scrollIntoView({ behavior: 'smooth' });
      } else if (hash === '#tutorials') {
        // Logic for tutorials section
  ...
  return (
    <main>
      ...
      <div className={`bottom-animate ${scrollY > 100 ? "end-animation" : ""}`}>
        ...
        <section ref={instructionsRef} className="instructions-section lower-section" id="instructions">
        ...
        <section ref={techSpecsRef} className="tech-specs-section lower-section" id="tech-specs">
          <div className="container lower-container">
            <h1>Tech Specs</h1>
        ...
        <section ref={tutorialsRef} className="tutorials-section" id="tutorials">
          <div className="container lower-container">
            <h1>Tutorials</h1>
